...
exports.lecture_Order = function (req, res) {
    var sending = [];
    c.query(query.lecture_Order, null)
        .on('result', function (res) {
            res.on('row', function (row) {
                sending.push(row);
            });
...
exports.insert_qna = function (req, res) {
    ...
    console.log(write_qna);
    c.query(query.insert_qna, [event_ID,user_class_ID,user_ID,schedule_ID,event_ID,user_class_ID,user_ID,schedule_ID,write_qna])
        .on('result', function (res) {
            res.on('row', function (row) {
