...
// 강의 리스트 쿼리
exports.lecture_Order="select * from evnet_schedule_D " +
"inner join user_D " +
"on evnet_schedule_D.user_ID = user_D.user_ID " +
"and evnet_schedule_D.event_ID=user_D.event_ID " +
"and evnet_schedule_D.user_class_ID=user_D.user_class_ID " +
"where isnull(evnet_schedule_D.is_del) " +
...
"inner join evnet_schedule_D " +
"on QNA_D.event_ID = evnet_schedule_D.event_ID " +
"and QNA_D.user_class_ID = evnet_schedule_D.user_class_ID " +
"and QNA_D.user_ID = evnet_schedule_D.user_ID " +
"and QNA_D.schedule_ID = evnet_schedule_D.schedule_ID " +
